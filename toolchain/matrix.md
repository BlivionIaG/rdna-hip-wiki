...
| TheRock `gfx103X-dgpu` | gfx1030 Release Ready; libs excluded. Nightly compiler **SMP ww33-2.6-1** / amd-llvm `e9e55b898a1b` (gfx1250-strict, not RDNA) | Compiler target is real | Build for `gfx1030`; no CK/hipBLASLt. Live dest still 7.14.0 |
