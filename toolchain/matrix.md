...
| TheRock `gfx103X-dgpu` | gfx1030 Release Ready; libs excluded. Nightly tip still `10.1.0a20260910` L+W (core + device-gfx1030/1100/900; no 0911 yet); compiler **SMP ww33-2.9** / amd-llvm `d19dd10a11f4` (TheRock HEAD `f3f46df9`; [#8108](https://github.com/ROCm/TheRock/pull/8108)) | Compiler target is real | Build for `gfx1030`; no CK/hipBLASLt. Live dest still 7.14.0 |
