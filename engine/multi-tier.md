...
Date: 2026-08-18. Engine contract. **Product path (locked):** optimize **vLLM fork first**, then **Llaminar**. SGLang is not the next engine. Occupancy + V620 HIP MoE still first. Do not invent tok/s.

Silicon: [silicon/hetero-moe-w7800-v620.md](../silicon/hetero-moe-w7800-v620.md). V340L: [silicon/v340l.md](../silicon/v340l.md). Related: [moe.md](moe.md), [deepep.md](deepep.md), [alt-engines.md](alt-engines.md).
...
## Engine base (locked 2026-08-18, corrected)
...
Do **not** block occupancy or HIP MoE on the Llaminar port.
...
**HIP:** do not call `__builtin_amdgcn_fdot2` / `sdot4` on gfx900. Old HIP-Clang notes that say “fdot2 on gfx9+” mean Vega20+. On V340L the honest inner loop is packed FMA / `mad_mix` into fp32 accum. Llaminar gfx906 DOT objects **will not load**. A V340L backend is a third ISA, after occupancy + V620 HIP MoE.
...
3. Measured W7800↔V620 activation matrix.
...
7. V340L gfx900 packed-mix backend — Later, not a V620 or gfx906 drop-in.
