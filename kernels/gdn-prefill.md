# GDN chunked prefill — extras HIP (`e054854f`)

`b53a7a2` landed the 5 kernels. Two later fixes make multi-chunk **correct**. `e054854f` is spill/LDS on **delta_h only** (not a tok/s close):
