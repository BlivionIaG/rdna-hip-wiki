...
| 3 | Align `__shared__` tiles: `alignas(16)` on every 128-bit view; allocation is **1 KB granule, 1 KB aligned**. Cap **64 KB/WG**. | ISA §3.6.6. `ds_read_b128` needs 16 B alignment (LLVM D92767). No HIP builtin for `ds_read_b128`. | RDNA 2 ISA 70648; LLVM `ds_read_b128` |
